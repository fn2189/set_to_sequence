...
- Words: python scripts/digits_reordering.py --pickle-file pickles/words_reordering_10000_2000_5_2019-06-18_12:32:55.406161.pkl  --hidden-dims 512 --lstm-steps 10 --lr 1e-4 --batch-size 32 --epochs 100 --saveprefix checkpoints --tensorboard-saveprefix tensorboard/ --print-offset 100 --reader words --input-dim 26
