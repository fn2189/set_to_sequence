"""
RUN EXAMPLE: 
- digits: python scripts/digits_reordering_test.py --pickle-file pickles/digits_reordering_10000_2000_10_2019-08-07_12:00:48.139281.pkl --resume checkpoints/digits/1/ep_10_map_inf_latest.pth.tar --hidden-dims 32 --lstm-steps 10
